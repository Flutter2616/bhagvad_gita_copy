...
//
//     final slokmodal = slokmodalFromJson(jsonString);

import 'dart:convert';

List<Slokmodal> slokmodalFromJson(String str) => List<Slokmodal>.from(json.decode(str).map((x) => Slokmodal.fromJson(x)));

String slokmodalToJson(List<Slokmodal> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Slokmodal {
  ...
  factory Slokmodal.fromJson(Map<String, dynamic> json) => Slokmodal(
    id: json["id"],
