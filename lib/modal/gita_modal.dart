...
//
//     final gitamodal = gitamodalFromJson(jsonString);

import 'dart:convert';

List<Gitamodal> gitamodalFromJson(String str) => List<Gitamodal>.from(json.decode(str).map((x) => Gitamodal.fromJson(x)));

String gitamodalToJson(List<Gitamodal> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Gitamodal {
  ...
  factory Gitamodal.fromJson(Map<String, dynamic> json) => Gitamodal(
    id: json["id"],
    name: json["name"],
    slug: json["slug"],
